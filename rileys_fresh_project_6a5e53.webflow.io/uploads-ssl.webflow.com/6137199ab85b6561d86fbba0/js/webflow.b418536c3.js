...
! function(t) {
    ...
    window.tram = function(t) {
        ...
        if (z.transition) {
            var M = z.timing.dom;
            if (C.style[M] = f["ease-in-back"][0], !C.style[M])
        ...
        var D = e.frame = function() {
            ...
            W = l(function(e) {
                function n() {
                    ...
                    if (r)
                        for (D(n), e = j(), t = r; t--;)(i = u[t]) && i.render(e)
                }
                var i = {
                    ease: f.ease[1],
                    from: 0,
    ...
    i.define("navbar", t.exports = function(t, e) {
        ...
        function A(n, i) {
            ...
            c && "/" === c.attr("href") && null == c.attr("aria-label") && c.attr("aria-label", "home"), a.button.attr("style", "-webkit-user-select: text;"), null == a.button.attr("aria-label") && a.button.attr("aria-label", "menu"), a.button.attr("role", "button"), a.button.attr("tabindex", "0"), a.button.attr("aria-controls", a.overlayContainerId), a.button.attr("aria-haspopup", "menu"), a.button.attr("aria-expanded", "false"), a.el.off(m), a.button.off(m), a.menu.off(m), S(a), s ? (T(a), a.el.on("setting" + m, function(t) {
                return function(n, i) {
                    i = i || {};
                    var r = f.width();
                    S(t), !0 === i.open && N(t, !0), !1 === i.open && q(t, !0), t.open && e.defer(function() {
                        r !== f.width() && z(t)
                    })
                }
            }(a))) : (! function(e) {
            ...
            }(a), a.button.on("click" + m, M(a)), a.menu.on("click" + m, "a", I(a)), a.button.on("keydown" + m, function(t) {
                return function(e) {
                    switch (e.keyCode) {
                        case o.SPACE:
                        case o.ENTER:
        ...
        function N(t, e) {
            if (!t.open) {
                t.open = !0, t.menu.each(F), t.links.addClass(x), t.dropdowns.addClass(g), t.dropdownToggle.addClass(b), t.dropdownList.addClass(y), t.button.addClass(w);
                var n = t.config;
                ...
                var r = $(t),
                    ...
                    u = t.el.height(),
                    c = t.el[0];
                if (j(0, c), k.intro(0, c), i.redraw.up(), s || d.on("click" + m, t.outside), e) p();
                else {
        ...
        function q(t, e) {
            ...
            function u() {
                t.menu.height(""), l(t.menu).set({
                    x: 0,
                    y: 0
                }), t.menu.each(L), t.links.removeClass(x), t.dropdowns.removeClass(g), t.dropdownToggle.removeClass(b), t.dropdownList.removeClass(y), t.overlay && t.overlay.children().length && (_.length ? t.menu.insertAfter(_) : t.menu.prependTo(t.parent), t.overlay.attr("style", "").hide()), t.el.triggerHandler("w-close"), t.button.attr("aria-expanded", "false")
            }
        }
        return c
    })
